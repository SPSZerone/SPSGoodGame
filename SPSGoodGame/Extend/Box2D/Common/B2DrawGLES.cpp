...
B2DrawGLES::B2DrawGLES( float32 fPTMRatio )
    : mRatio( fPTMRatio )
{
    this->initShader();
}
...
void B2DrawGLES::EnableAllDrawFlags()
{
	uint32 flags = 0;
...
void B2DrawGLES::initShader( void )
{
...
void B2DrawGLES::DrawPolygon(const b2Vec2* old_vertices, int vertexCount, const b2Color& color)
{
    mShaderProgram->use();
...
void B2DrawGLES::DrawSolidPolygon(const b2Vec2* old_vertices, int vertexCount, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
...
void B2DrawGLES::DrawCircle(const b2Vec2& center, float32 radius, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
...
void B2DrawGLES::DrawSolidCircle(const b2Vec2& center, float32 radius, const b2Vec2& axis, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
...
void B2DrawGLES::DrawSegment(const b2Vec2& p1, const b2Vec2& p2, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
...
void B2DrawGLES::DrawTransform(const b2Transform& xf)
{
    b2Vec2 p1 = xf.p, p2;
...
void B2DrawGLES::DrawPoint(const b2Vec2& p, float32 size, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
...
void B2DrawGLES::DrawString(int x, int y, const char *string, ...)
{
...
void B2DrawGLES::DrawAABB(b2AABB* aabb, const b2Color& color)
{
    mShaderProgram->use();
    mShaderProgram->setUniformsForBuiltins();
